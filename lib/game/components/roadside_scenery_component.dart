...
class RoadsideSceneryComponent extends PositionComponent {
  ...
  final Paint _darkTreePaint = Paint()
    ..color = const Color(0xFF21452E);

  final Paint _lightTreePaint = Paint()
    ..color = const Color(0xFF315C3A);

  final Paint _trunkPaint = Paint()
    ..color = const Color(0xFF60452F);

  final Paint _rockPaint = Paint()
    ..color = const Color(0xFF626B68);

  final Paint _rockHighlightPaint = Paint()
    ..color = const Color(0xFF818A86);

  final Paint _grassPaint = Paint()
    ..color = const Color(0xFF365C2D);
