...
class PhysicsVehicle extends BodyComponent {
  ...
  void _drawLowerBody(Canvas canvas) {
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(-2.1, -0.45, 4.2, 0.90),
    ...
    canvas.drawRect(
      const Rect.fromLTWH(-1.92, 0.20, 3.78, 0.27),
      _bodyShadowPaint,
    );
  }
  ...
  void _drawTruckBed(Canvas canvas) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(-2.02, -0.68, 1.62, 0.85),
    ...
    canvas.drawRect(
      const Rect.fromLTWH(-0.52, -0.80, 0.10, 0.95),
      _bodyShadowPaint,
    );

    canvas.drawRect(
      const Rect.fromLTWH(-2.03, -0.55, 0.08, 0.66),
      _bodyShadowPaint,
    );
  }
  ...
  void _drawCabin(Canvas canvas) {
    final Path cabin = Path()
      ..moveTo(-0.48, -0.45)
      ..lineTo(-0.18, -1.36)
      ..quadraticBezierTo(-0.12, -1.53, 0.10, -1.53)
      ..lineTo(0.92, -1.53)
      ..quadraticBezierTo(1.12, -1.51, 1.26, -1.31)
      ..lineTo(1.55, -0.45)
      ..close();
    ...
    final Path frontWindow = Path()
      ..moveTo(0.50, -1.36)
      ..lineTo(0.88, -1.36)
      ..quadraticBezierTo(1.00, -1.34, 1.08, -1.22)
      ..lineTo(1.35, -0.58)
      ..lineTo(0.50, -0.58)
      ..close();
    ...
    canvas.drawRect(const Rect.fromLTWH(0.39, -1.40, 0.11, 0.86), _darkPaint);
  ...
  void _drawWheelArches(Canvas canvas) {
    canvas.drawArc(
      const Rect.fromLTWH(-1.95, -0.12, 1.00, 1.00),
      3.141592653589793,
      3.141592653589793,
      false,
      _wheelArchPaint,
    ...
    canvas.drawArc(
      const Rect.fromLTWH(0.95, -0.12, 1.00, 1.00),
      3.141592653589793,
      3.141592653589793,
      false,
      _wheelArchPaint,
  ...
  void _drawDetails(Canvas canvas) {
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(-2.20, 0.14, 0.32, 0.25),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(1.90, 0.12, 0.34, 0.27),
        const Radius.circular(0.06),
      ),
      _darkPaint,
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(-0.70, 0.38, 2.20, 0.10),
